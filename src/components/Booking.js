      ...
      <div className="row justify-content-center">
        ...
        <div className="card booking-card mx-4 mb-5">
          ...
          <div className="card-body">
            ...
            <a href="https://wa.me/081234567890" className="btn btn-dark">Cruise</a>
        ...
        <div className="card booking-card mx-4 mb-5">
          ...
          <div className="card-body">
            ...
            <a href="https://wa.me/081234567890" className="btn btn-dark">Bus</a>
            <a href="https://wa.me/081234567890" className="btn btn-dark">Car</a>
          </div>
        </div>
      </div>
    </div>
